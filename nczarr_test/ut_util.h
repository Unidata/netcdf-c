...
extern void freeprojvector(size_t rank, NCZProjection** vec);
...
extern void slices2vector(size_t rank, NCZSlice* slices, size64_t** startp, size64_t** stopp, size64_t** stridep, size64_t** maxp);
