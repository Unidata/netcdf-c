#!/bin/bash
set -x
export PATH=/c/Users/wfisher/Desktop/hdf5-1.8.9/build_win/bin:/c/Users/wfisher/Desktop/szip-2.1/build_win32_static/bin:/c/Users/wfisher/Desktop/szip-2.1/build_win32_dll/bin:$PATH
