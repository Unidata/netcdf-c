...
{1,"2.1.5", "5 bytes (U-00200000)",        "�����"},
{1,"2.1.6", "6 bytes (U-04000000)",        "������"},
...
{1,"2.2.5", "5 bytes (U-03FFFFFF)",        "�����"},
{1,"2.2.6", "6 bytes (U-7FFFFFFF)",        "������"},

/*2.3  Other boundary conditions*/

{0,"2.3.1", "U-0000D7FF = ed 9f bf", "퟿"},
{0,"2.3.2", "U-0000E000 = ee 80 80", ""},
{0,"2.3.3", "U-0000FFFD = ef bf bd", "�"},
{0,"2.3.4", "U-0010FFFF = f4 8f bf bf", "􏿿"},
{1,"2.3.5", "U-00110000 = f4 90 80 80", "����"},
NULLTEST
};
...
*/
{1,"3.3.1", "2-byte sequence with last byte missing (U+0000)",     "�"},
{1,"3.3.2", "3-byte sequence with last byte missing (U+0000)",     "��"},
{1,"3.3.3", "4-byte sequence with last byte missing (U+0000)",     "���"},
{1,"3.3.4", "5-byte sequence with last byte missing (U+0000)",     "����"},
{1,"3.3.5", "6-byte sequence with last byte missing (U+0000)",     "�����"},
{1,"3.3.6", "2-byte sequence with last byte missing (U-000007FF)", "�"},
{1,"3.3.7", "3-byte sequence with last byte missing (U-0000FFFF)", "��"},
{1,"3.3.8", "4-byte sequence with last byte missing (U-001FFFFF)", "���"},
{1,"3.3.9", "5-byte sequence with last byte missing (U-03FFFFFF)", "����"},
{1,"3.3.10", "6-byte sequence with last byte missing (U-7FFFFFFF)", "�����"},
...
{1,"4.1.1", "U+002F = c0 af             ", "��"},
{1,"4.1.2", "U+002F = e0 80 af          ", "���"},
{1,"4.1.3", "U+002F = f0 80 80 af       ", "����"},
{1,"4.1.4", "U+002F = f8 80 80 80 af    ", "�����"},
{1,"4.1.5", "U+002F = fc 80 80 80 80 af ", "������"},
...
{1,"4.2.1", "U-0000007F = c1 bf             ", "��"},
{1,"4.2.2", "U-000007FF = e0 9f bf          ", "���"},
{1,"4.2.3", "U-0000FFFF = f0 8f bf bf       ", "����"},
{1,"4.2.4", "U-001FFFFF = f8 87 bf bf bf    ", "�����"},
{1,"4.2.5", "U-03FFFFFF = fc 83 bf bf bf bf ", "������"},
...
{1,"4.3.1", "U+0000 = c0 80             ", "��"},
{1,"4.3.2", "U+0000 = e0 80 80          ", "���"},
{1,"4.3.3", "U+0000 = f0 80 80 80       ", "����"},
{1,"4.3.4", "U+0000 = f8 80 80 80 80    ", "�����"},
{1,"4.3.5", "U+0000 = fc 80 80 80 80 80 ", "������"},
...
{1,"5.1.1", "U+D800 = ed a0 80 ", "���"},
{1,"5.1.2", "U+DB7F = ed ad bf ", "���"},
{1,"5.1.3", "U+DB80 = ed ae 80 ", "���"},
{1,"5.1.4", "U+DBFF = ed af bf ", "���"},
{1,"5.1.5", "U+DC00 = ed b0 80 ", "���"},
{1,"5.1.6", "U+DF80 = ed be 80 ", "���"},
{1,"5.1.7", "U+DFFF = ed bf bf ", "���"},

/*5.2 Paired UTF-16 surrogates */

{1,"5.2.1", "U+D800 U+DC00 = ed a0 80 ed b0 80 ", "������"},
{1,"5.2.2", "U+D800 U+DFFF = ed a0 80 ed bf bf ", "������"},
{1,"5.2.3", "U+DB7F U+DC00 = ed ad bf ed b0 80 ", "������"},
{1,"5.2.4", "U+DB7F U+DFFF = ed ad bf ed bf bf ", "������"},
{1,"5.2.5", "U+DB80 U+DC00 = ed ae 80 ed b0 80 ", "������"},
{1,"5.2.6", "U+DB80 U+DFFF = ed ae 80 ed bf bf ", "������"},
{1,"5.2.7", "U+DBFF U+DC00 = ed af bf ed b0 80 ", "������"},
{1,"5.2.8", "U+DBFF U+DFFF = ed af bf ed bf bf ", "������"},
NULLTEST
};
