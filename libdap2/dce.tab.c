...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, DCEparsestate* parsestate)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (parsestate);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, DCEparsestate* parsestate)
{
  YYFPRINTF (yyo, "%s %s (",
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, DCEparsestate* parsestate)
{
