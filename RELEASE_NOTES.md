...
* [Enhancement] Turn on the XArray convention for NCZarr files by default. WARNING, this now means that the mode must contain "nczarr" or "zarr" even if "xarray" or "noxarray" is specified. See [Github #2257](https://github.com/Unidata/netcdf-c/pull/2257).
