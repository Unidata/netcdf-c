...
* Rebuild the S3-related code and other changes necessary to build cleanly on github actions. See [Github #????](https://github.com/Unidata/netcdf-c/pull/????) for more information.
