...
# TDS Catalog: http://motherlode.ucar.edu:8081/thredds/catalog/public/dataset/catalog.html

TDSURL1="http://motherlode.ucar.edu:8081/thredds/dodsC/public/dataset"
TDSTESTS1="\
tst-striped.nc \
