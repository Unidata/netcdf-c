 ...
 *   $Header: /upc/share/CVS/netcdf-3/libncdap3/old_ncdap3.c,v 1.1 2010/05/25 17:54:07 dmh Exp $
 *********************************************************************/
#include "config.h"
#include "ncdap3.h"
#include "dispatch3.h"
...
size_t dapzerostart3[NC_MAX_DIMS];
size_t dapsinglecount3[NC_MAX_DIMS];
ptrdiff_t dapsinglestride3[NC_MAX_DIMS];
...
applyclientparamcontrols3(NCDRNO* drno)
{
    ...
    /* Establish the mode */
    translation = 3;
    model = (char*)dapparamlookup(params,"model");
    drno->controls.flags |=
