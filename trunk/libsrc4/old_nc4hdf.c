/*
  ...
  $Id: old_nc4hdf.c,v 1.1 2010/05/25 17:54:26 dmh Exp $
*/
...
int 
RENAME44(put_vara)(NC_FILE_INFO_T *nc, int ncid, int varid, const size_t *startp, 
...
int 
RENAME44(get_vara)(NC_FILE_INFO_T *nc, int ncid, int varid, const size_t *startp, 
		      const size_t *countp, nc_type mem_nc_type, int is_long, void *data)
{
   NC_GRP_INFO_T *grp, *g;
   NC_HDF5_FILE_INFO_T *h5;
