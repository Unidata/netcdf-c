...
Reviewing changes from new contributors is part of growing the next generation of contributors and sustaining the project. We want the suite of NSF Unidata projects to be welcoming and open to aspiring compiler engineers who are willing to invest time and effort to learn and grow, because growing our contributor base and recruiting new maintainers helps sustain the project over the long term. Being open to contributions and liberally granting commit access is a big part of how projects at NSF Unidata have grown and successfully been adopted all across the industry. We therefore automatically encourage maintainers to spend their time to help new contributors learn.
